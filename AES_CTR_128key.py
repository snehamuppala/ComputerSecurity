...
print("AES in the CTR mode -128 bit key")
def int_of_string(s):
...
print "Time taken to generate key 128 bit:  %s seconds" % (time.time() - start_time)
...
print ("Speed per byte to Decrypt File 1KB seconds :"+str(bytes_speed))
print(" ")
...
print ("Speed per byte to Decrypt File 1MB seconds:"+str(bytes_speed))
